...
def process_all_folders():
    ...
    for mask_path in tqdm(all_mask_files, desc="Processing files", unit="file"):
        ...
        if match:
            ...
            if os.path.exists(image_path):
                yolo_annotations = process_image_and_mask(image_path, mask_path)
                ...
                output_image_file = os.path.splitext(os.path.basename(image_file))[0] + '.jpg'
