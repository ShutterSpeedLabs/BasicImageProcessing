...
if __name__ == "__main__":
    # Example usage
    input_folder = "/media/kisna/bkp_data/DeOldify/vid_data_colorize/JaneTeriNazronN/JaneTeriNazronN_in/video_2/"
    output_folder = "/media/kisna/bkp_data/DeOldify/vid_data_colorize/JaneTeriNazronN/JaneTeriNazronN_key/video_2_key/"
    extract_keyframes(input_folder, output_folder, threshold=75)
